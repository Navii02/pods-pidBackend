...
const { uploadbulkModal, saveBulkModal, AssignedBulkModelSave, saveChangedUnassigned } = require("../controllers/BulkModalController");
...
router.post('/upload-bulk-files', convertedFilesUpload.array('files'),uploadbulkModal)
